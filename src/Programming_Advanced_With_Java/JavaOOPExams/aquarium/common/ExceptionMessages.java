package Programming_Advanced_With_Java.JavaOOPExams.aquarium.common;
...
public class ExceptionMessages {
    ...
    public static final String INVALID_AQUARIUM_TYPE = "Invalid Programming_Advanced_With_Java.JavaOOPExams.aquarium type.";
