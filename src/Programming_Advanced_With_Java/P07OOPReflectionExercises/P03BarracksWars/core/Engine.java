package Programming_Advanced_With_Java.P07OOPReflectionExercises.P03BarracksWars.core;

import Programming_Advanced_With_Java.P07OOPReflectionExercises.P03BarracksWars.data.CommandInterpreterImpl;
import Programming_Advanced_With_Java.P07OOPReflectionExercises.P03BarracksWars.interfaces.*;
...
public class Engine implements Runnable {
	...
	public void run() {
		...
		while (true) {
			...
			} catch (IOException | ExecutionControl.NotImplementedException
